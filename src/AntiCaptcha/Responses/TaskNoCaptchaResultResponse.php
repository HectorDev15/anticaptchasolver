...
use AntiCaptchaSolver\Solutions\NoCaptchaSolution;
 ...
 */
class TaskNoCaptchaResultResponse extends Response
{
    /**
    ...
    public function __construct(ResponseInterface $response)
    {
        ...
        $this->solution = $this->status == 'ready' 
            ? new NoCaptchaSolution($this->array_get($this->response_body, 'solution')) 
            : null;
    }
     ...
     * Task result data
     * 
     * @return NoCaptchaSolution|null
     */
    public function getSolution(): ?NoCaptchaSolution
    {
